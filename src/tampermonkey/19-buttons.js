/************************************************************
  ...
  dock.addEventListener('click',(e) => {const action = e?.target?.dataset?.tbAction;
                                     ...
                                     if (action === 'confirmIneligible') {if (textBuilderState.data.researchType === 'Can’tDo: Initial Warrant') return textBuilderSet('courts',{courts:[]}); if (textBuilderState.data.workflow === 'walkInDropIn' || ['Can’tDo: Out of Network','Can’tDo: Repeat Attempt','Can’tDo: Fresh Start Friday'].includes(textBuilderState.data.researchType)) return textBuilderSet('message'); if (textBuilderState.data.researchType === 'CanDo: + Can’tDo') return textBuilderSet('address'); return textBuilderSet('courts',{courts:[]});}
